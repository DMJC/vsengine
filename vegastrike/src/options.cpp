...
void vs_options::init()
{
    ...
    enable_vr                = XMLSupport::parse_bool( vs_config->getVariable( "graphics", "UseVR", "false" ) );
    vr_fov                   = XMLSupport::parse_floatf( vs_config->getVariable( "graphics", "VRfov", "100" ) );
    vr_aspect                = XMLSupport::parse_floatf( vs_config->getVariable( "graphics", "VRaspect", "1.33" ) );
    vr_znear                 = XMLSupport::parse_floatf( vs_config->getVariable( "graphics", "VRznear", "1" ) );
    vr_zfar                  = XMLSupport::parse_floatf( vs_config->getVariable( "graphics", "VRzfar", "100000" ) );
