...
namespace Audio {
    ...
    protected:
        ...
        RenderableSource(Source *source) noexcept;
    ...
    public:
         ...
         */
        Timestamp getPlayingTime() const noexcept(false);
         ...
         */
        void update(int flags, const Listener& sceneListener) noexcept;
    ...
    protected:
        ...
        /** @see getPlayingTime.*/
        virtual Timestamp getPlayingTimeImpl() const noexcept(false) = 0;
        
        /** @see update. */
        virtual void updateImpl(int flags, const Listener& sceneListener) noexcept(false) = 0;
        
        /** @see seek. */
        virtual void seekImpl(Timestamp time) noexcept(false) = 0;
    };
