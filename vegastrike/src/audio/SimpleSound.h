...
namespace Audio {
    ...
    protected:
        ...
        SimpleSound(const std::string& name, VSFileSystem::VSFileType type = VSFileSystem::UnknownFile, bool streaming = false) noexcept;
    ...
    protected:
         ...
         */
        void loadStream() noexcept(false);
        
        /** Uninitialize the stream
         * @remarks Calling this when isStreamLoaded() returns false will raise an
         *      ResourceNotLoadedException.
         */
        void closeStream() noexcept(false); //throw(ResourceNotLoadedException);
        
        /** Get a pointer to the stream
         * @remarks Calling this when isStreamLoaded() returns false will raise an
         *      ResourceNotLoadedException.
         */
        SharedPtr<Stream> getStream() const noexcept(false); //throw(ResourceNotLoadedException);
         ...
         */
        void readBuffer(SoundBuffer &buffer) noexcept(false);
    ...
    protected:
        ...
        virtual void abortLoad() noexcept;
