...
namespace Audio {
    ...
    protected:
        ...
        Stream(const std::string& path) noexcept(false);
        
        /** Internal write access to stream format, for derived classes */
        Format& getFormatInternal() noexcept { return streamFormat; }
    ...
    public:
        ...
        const Format& getFormat() const noexcept { return streamFormat; }
         ...
         *      So use sparingly.
         */
        double getLength() noexcept(false);
         ...
         */
        unsigned int read(void *buffer, unsigned int bufferSize) noexcept(false);
         ...
         */
        void seek(double position) noexcept(false);
    ...
    protected:
        ...
        /** @see getLength */
        virtual double getLengthImpl() const noexcept(false) = 0;
        
        /** @see getPosition */
        virtual double getPositionImpl() const noexcept = 0;
        
        /** @see seek */
        virtual void seekImpl(double position) noexcept(false) = 0;
         ...
         */
        virtual void getBufferImpl(void *&buffer, unsigned int &bufferSize) noexcept(false) = 0;
         ...
         * @see getBufferImpl
         */
        virtual void nextBufferImpl() noexcept(false) = 0;
    };
