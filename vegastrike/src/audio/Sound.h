...
namespace Audio {
    ...
    protected:
        ...
        Sound(const std::string& name, bool streaming) noexcept;
        
        /** Protected Write access to the sound's format, for implementations. */
        Format& getFormat() noexcept { return format; };
    ...
    public:
        ...
        const Format& getFormat() const noexcept { return format; };
        
        /** Return whether the resource has been loaded or not */
        bool isLoaded() const noexcept { return flags.loaded; }
        
        /** Return whether the resource is being loaded in the background */
        bool isLoading() const noexcept { return flags.loading; }
        
        /** Return whether the resource is being loaded in the background */
        bool isStreaming() const noexcept { return flags.streaming; }
         ...
         *      became loaded.
         */
        void load(bool wait = true) noexcept(false);
    ...
    protected:
         ...
         */
        virtual void onLoaded(bool success) noexcept;
         ...
         */
        virtual void waitLoad() noexcept(false);
        
        /** Load the resource
         * @note Assume it is unloaded and not loading
         */
        virtual void loadImpl(bool wait) noexcept(false) = 0;
         ...
         */
        virtual void abortLoad() noexcept = 0;
        
        
        /** Unload the resource.
         * @note Assume it is loaded
         */
        virtual void unloadImpl() noexcept = 0;
