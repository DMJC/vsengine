...
//    if(vr_mode == 0){
 ...
 /*   }else{
   	 glViewport( x, y, xsize/2, ysize );
   	 glScissor( x, y, xsize/2, ysize );
   	 if (x == 0 && y == 0 && xsize == g_game.x_resolution/2 && ysize == g_game.y_resolution)
   	     glDisable( GL_SCISSOR_TEST );
   	 else
   	     glEnable( GL_SCISSOR_TEST );

   	 glViewport( x/2, y, xsize, ysize );
   	 glScissor( x/2, y, xsize, ysize );
   	 if (x == g_game.x_resolution/2 && y == 0 && xsize == g_game.x_resolution && ysize == g_game.y_resolution)
   	     glDisable( GL_SCISSOR_TEST );
   	 else
   	     glEnable( GL_SCISSOR_TEST );
    }*/
