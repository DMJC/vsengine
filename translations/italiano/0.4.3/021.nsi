...
;        ExecWait $INSTDIR/Vegastrike-0.4.3/bin/OpenALwEAX.exe
      ...
      MessageBox MB_YESNO "Installazione terminata con successo. Desideri leggere il manuale di VegaStrike?" IDNO NoReadme
